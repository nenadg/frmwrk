...
const createLeaf = (parentId, attributes) => {
	...
	if (leaf.componentName) {
	  const component = getComponent(leaf.componentName);

	  if (component) {

	    const componentInstance = new component();
	    const componentConfig = componentInstance.getConfig();
	    const componentType = getComponentType(componentConfig);
	    const originalModelName = componentConfig[componentType]?.model;

	    if (originalModelName) {
	      leaf.model.originalModelName = originalModelName;
	    }
	  }
	}
