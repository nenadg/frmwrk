...
let tagsRe = new RegExp(
  "^(br|basefont|hr|input|source|frame|" +
    ...
    "ins|kbd|keygen|label|legend|li|map|mark|menu|meter|nav|" +
    "noframes|noscript|object|ol|optgroup|output|p|pre|progress|" +
    "q|rp|rt|ruby|s|samp|script|section|select|small|span|strike|" +
    "strong|style|sub|summary|sup|table|tbody|td|textarea|tfoot|" +
    "th|thead|time|title|tr|track|tt|u|ul|var|video|main|svg|polyline|" +
    "circle|animate|animateMotion|animateTransform|audio|canvas|" +
    "clipPath|defs|desc|discard|ellipse|feBlend|feColorMatrix|" +
    ...
    "filter|foreignObject|g|iframe|image|line|linearGradient|marker|mask|" +
    "metadata|mpath|path|pattern|polygon|polyline|radialGradient|rect|" +
    "set|stop|style|switch|symbol|text|textPath|tspan|" +
    "unknown|use" +
    ")$",
  "i"
);
